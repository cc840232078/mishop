        ...
        <div class="row" style="margin-left: 1px;margin-top: 0px;margin-right: 1px;">
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <div class="box-body">
                        <div class="col-xs-12">
                            <a href="/user/form" type="button" class="btn btn-default btn-sm" style="width:auto;margin-left: 10px"><i class="fa fa-plus"></i> 新增</a>&nbsp;&nbsp;
                            <button type="button" class="btn btn-default btn-sm" style="width:auto" onclick="App.deleteMulti('/user/delete')"><i class="fa fa-trash"></i> 删除</button>&nbsp;&nbsp;
...
<script>
    ...
    $(function () {
        var _columns = [
            ...
            {"data": "updated"},
            {
                "data": function (row, type, val, meta) {
                    ...
                    return '<button type="button" class="btn btn-sm btn-primary" onclick="App.detail(\'' + detailUrl + '\')"><i class="fa fa-search"></i> 查看</button>&nbsp;&nbsp;&nbsp;' +
                        '<a href="/user/form?id='+row.id +'" type="button" class="btn btn-sm btn-info"><i class="fa fa-edit"></i> 编辑</a>&nbsp;&nbsp;&nbsp;' +
            ...
            _dataTable =  App.userTable("/user/page",_columns);
    });
        function search() {
