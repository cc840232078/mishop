        ...
        <div class="row" style="margin-left: 1px;margin-top: 8px;margin-right: 1px;">
            <div class="col-xs-12">
                <div class="box box-info" >
                    ...
                    <!-- form start -->
                    <jsp:useBean id="member" class="com.xiaomi.mishop.entity.User" scope="request"/>
                    <form:form id="inputForm" cssClass="form-horizontal" action="/member/save" method="post"  modelAttribute="user">
                        <form:hidden path="id"/>
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <form:input path="truename" cssClass="form-control required" placeholder="姓名"/>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <form:input path="address" cssClass="form-control required mobile" placeholder="地址"/>
                                </div>
                            </div>
