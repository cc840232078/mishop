...
<head>
    ...
    <title>小米商城</title>
    <link rel="stylesheet" type="text/css" href="/static/css/style.css?333=333">
    <script type="text/javascript" src="/static/jquery/jquery-1.8.2.js"></script>

    <script type="text/javascript">
        $(function () {
            var img = document.getElementById("img");
            var imgs = ["/static/image/banner.jpg", "/static/image/banner2.jpg", "/static/image/xmad.png.jpg"];
            var index = 0;
...
<header>
    <div class="top center">
        ...
        <div class="right fr">
            <div class="gouwuche fr"><a href="/goodsCar">购物车</a></div>
            <div class="fr">
                <ul>
...
<!-- start banner_y -->
<div class="banner_y center" style="width:1226px;height:460px;background: url('/static/image/xmad.png.jpg') no-repeat;"
     id="img">
    <div class="nav">
        <ul>
            <li>
