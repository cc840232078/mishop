...
<div class="grzxbj">
    <div class="selfinfo center">
        ...
        <div class="rtcont fr">
            ...
            <form:form action="updateform" modelAttribute="address">
                <form:hidden path="id"/>
                <form:hidden path="isDefault"/>
                <%--<form:hidden path="userid"></form:hidden>--%>
                <form:input path="shouhuoren" cssClass="subgrzl ml40 "/>

                <form:input path="phone" cssClass="subgrzl ml40"/>

                <form:input path="address" cssClass="subgrzl ml40"/>
