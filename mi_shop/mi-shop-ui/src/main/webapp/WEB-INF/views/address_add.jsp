...
<div class="grzxbj">
    <div class="selfinfo center">
        ...
        <div class="rtcont fr">
            <div class="grzlbt ml40">修改地址信息</div>

            <form:form action="saveform" modelAttribute="address">
                <form:hidden path="id"></form:hidden>
                <%--<form:hidden path="userid"></form:hidden>--%>
                收货人:<form:input path="shouhuoren" cssClass="subgrzl ml20 "/>
                手机：<form:input path="phone" cssClass="subgrzl ml20"/>
                地址：<form:input path="address" cssClass="subgrzl ml20"/>
